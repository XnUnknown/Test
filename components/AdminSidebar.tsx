    ...
    <aside className="fixed inset-y-0 left-0 w-64 bg-gray-900 flex flex-col z-10">
      <div className="p-6 border-b border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-white text-sm">ExamPortal</p>
      ...
      <div className="p-4 border-t border-gray-700">
        ...
        <button onClick={handleSignOut} className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-colors">
